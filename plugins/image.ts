// Copy from: https://github.com/Renovamen/renovamen.github.io/blob/main/plugins/image.ts - 238efd8
...
export const remarkImage = (): ReturnType<RemarkPlugin> => {
    ...
    visit(tree, "image", (node, index, parent) => {
        ...
        const figNodes = [
            ...
            ...(desc
            ? [
                { type: "html", value: "<center><figcaption>" },
                ...fromMarkdown(desc).children,
                { type: "html", value: "</figcaption></center>" }
                ]
            : []),
            {
            type: "html",
